...
class Bimbler_Mobile_Widget extends WP_Widget {
...
/* ------------------------------------ */
	...
	public function __construct() {
		...
		parent::__construct( 'bimbler_mobile_widget', 
							'Bimbler Mobile Widget', 
							array(//'description' => 'List posts, comments, and RSVPs with or without tabs.', 
									'classname' => 'bimbler_mobile_widget') 
				);	
	}
...
/* ------------------------------------ */
	public function widget($args, $instance) {
		...
		// Setup the js to implement the scroller.
		//wp_register_script('bimbler-js', plugins_url('/js/bimbler.js', __FILE__), array('jquery'));
		//wp_enqueue_script('bimbler-js');
...
<script type="text/javascript">
    jQuery(function($){
		...
		$(window).scroll(function(e) {
		    ...
		    var scroller_anchor = $(".scroll_anchor").offset().top;
		     
		    // Check if the user has scrolled and the current position is after the scroller start location and if its not already fixed at the top
		    if ($(this).scrollTop() >= scroller_anchor && $('.mobile-container').css('position') != 'fixed')
		    {    // Change the CSS of the scroller to hilight it and fix it at the top of the screen.
		        ...
		        $('.scroll_anchor').css('height', '50px');
		    }
		    else if ($(this).scrollTop() < scroller_anchor && $('.mobile-container').css('position') != 'relative')
		    {    // If the user has scrolled back to the location above the scroller anchor place it back into the content.
		         
		        // Change the height of the scroller anchor to 0 and now we will be adding the scroller back to the content.
		        $('.scroll_anchor').css('height', '0px');
...
<!--   	<div class="scroll_anchor" style="position:fixed;"></div> -->


<!--	<div class="mobile-container"> -->
	
<!--  	<div class="alx-tabs-container" style="overflow-y: scroll !important; height:400px;"> --> 
 	<div class="alx-tabs-container" id= "arse" style="overflow-y: scroll !important; position: absolute; width: 100%; height: 100%; top: 1; left: 0;"> 
<!-- 	<div class="alx-tabs-container" style="overflow-y: scroll !important; height:100%;"> -->
<!--  	<div class="tabs-inner" style="overflow-y: scroll !important;"> -->
			...
			<ul id="tab-rsvps" class="alx-tab group <?php if($instance['rsvps_thumbs']) { echo 'avatars-enabled'; } ?>">
				...
				<li>
					...
					<div class="tab-item-inner group">
						<div class="tab-item-name"><?php echo $user_nick; ?> RSVPd 'Yes' to</div>
		...
		<?php 
			...
			<?php $recent->query('showposts='.$instance["recent_num"].'&ignore_sticky_posts=1');?>
			...
			<ul id="tab-recent" class="alx-tab group <?php if($instance['recent_thumbs']) { echo 'avatars-enabled'; } ?>">
				...
				<li>
					...
					<div class="tab-item-inner group">
						<?php if(0 /*$instance['tabs_category']*/) { ?><p class="tab-item-category"><?php the_category(' / '); ?></p><?php } ?>
...
//						print_r ($post);
					...
					<div class="tab-item-inner group">
						...
						<?php
							if ($first) {
								echo '<p>'. tribe_get_venue ($post->ID) .':</p>';
								
								echo '<div class="tribe-events-venue-map">';
								
								echo tribe_get_embedded_map ($post->ID, '75%', '150px', true);
