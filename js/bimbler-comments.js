 ...
 * Bimbler Comments
 * 
 * Uses the Framework7 messages, messagebar and template JS to implement
 * a nifty comment widget.
 *
...
var Messages = function (container, params) {
    ...
    // Set up the page so that the Messagebar can resize properly.
    $('#main-container').addClass ('page');
    $('#main-container').addClass ('view');

//    console.log ('Container:');
//    console.dir ($('#content-container'));
