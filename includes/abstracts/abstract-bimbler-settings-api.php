 ...
 * @author 		WooThemes
 */
abstract class Bimbler_Settings_API {

	/** @var string The plugin ID. Used for option names. */
	public $plugin_id = 'bimbler_';
	...
	public function get_form_fields() {
		return apply_filters( 'bimbler_settings_api_form_fields_' . $this->id, $this->form_fields );
	}
    ...
    public function process_admin_options() {
    	...
    	if ( count( $this->errors ) > 0 ) {
    		...
    		update_option( $this->plugin_id . $this->id . '_settings', apply_filters( 'bimbler_settings_api_sanitized_fields_' . $this->id, $this->sanitized_fields ) );
    		$this->init_settings();
    		return true;
    	}
    }
